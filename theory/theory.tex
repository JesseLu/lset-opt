...
\begin{equation}
    p_0 = \text{sign}(\phi_0)  (\gamma_1 + \gamma_2)(\gamma_3 + \gamma_4),
\end{equation}
...
\begin{equation}
    ...
    \begin{cases}
        \gamma_3 + \gamma_4 & \text{for $i = 1,2$,} \\
        \gamma_1 + \gamma_2 & \text{for $i = 3,4$.} 
    \end{cases}
\end{equation}
and for $i = 1,2$
\begin{equation}
...
When performing a topological update, the nucleation of islands can be performed. 
